...
//class UserRemoteMediator(private val service: RequestsApi, private val userRepositoriesDao: UserRepositoriesDao) : RemoteMediator<Int, UserModel>() {
...
//            }
//
//            val response = service.getRepositories("", 1)
